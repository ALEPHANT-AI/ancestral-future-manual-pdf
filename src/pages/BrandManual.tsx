      ...
      <div className="pt-20 print:pt-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="space-y-6">
                <div className="bg-black/40 backdrop-blur-md border border-green-500/30 rounded-xl p-6">
                  ...
                  <div className="text-gray-300 space-y-3 text-base lg:text-lg">
                    ...
                    <p className="text-green-400 font-bold text-lg">A escola te domesticou para seguir ordens. O trabalho te drenou para alimentar métricas. Big Tech te viciou para consumir atenção.</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-center">
                <img 
                  ...
                  className="w-full max-w-sm rounded-2xl shadow-2xl border border-green-500/30"
                />
              </div>
            </div>
        ...
        <div className="page-break min-h-screen bg-gradient-to-br from-black to-gray-900 p-8 print:p-4 relative">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="bg-black/40 backdrop-blur-md border border-green-500/30 rounded-xl p-6">
                <h3 className="text-2xl lg:text-3xl font-bold text-green-400 mb-4">200 ANOS DE DOMESTICAÇÃO</h3>
                <div className="text-gray-300 space-y-3 text-base lg:text-lg">
            ...
            <div className="bg-gradient-to-r from-green-600/30 to-green-400/30 border border-green-500/50 rounded-xl p-6">
              <h3 className="text-2xl lg:text-3xl font-bold text-green-400 mb-4 text-center">A TESE REVOLUCIONÁRIA</h3>
        ...
        <div className="page-break min-h-screen bg-gradient-to-br from-gray-900 to-black p-8 print:p-4 relative">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="bg-black/40 backdrop-blur-md border border-green-500/30 rounded-xl p-6">
                <h3 className="text-2xl lg:text-3xl font-bold text-green-400 mb-4">AS TECNOLOGIAS PERDIDAS</h3>
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-black/30 backdrop-blur-md border border-green-500/30 rounded-lg p-4">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <h4 className="text-lg font-bold text-green-400">AYAHUASCA</h4>
                    </div>
                  ...
                  <div className="bg-black/30 backdrop-blur-md border border-green-500/30 rounded-lg p-4">
                    <div className="flex items-center space-x-3 mb-3">
                      <Pyramid className="text-green-400" size={20} />
                      <h4 className="text-lg font-bold text-green-400">PIRÂMIDES</h4>
                    </div>
                  ...
                  <div className="bg-black/30 backdrop-blur-md border border-green-500/30 rounded-lg p-4">
                    <div className="flex items-center space-x-3 mb-3">
                      <TreePine className="text-green-400" size={20} />
                      <h4 className="text-lg font-bold text-green-400">AMAZÔNIA</h4>
                    </div>
            ...
            <div className="bg-gradient-to-r from-green-600/30 to-green-400/30 border border-green-500/50 rounded-xl p-6">
              <h3 className="text-xl lg:text-2xl font-bold text-green-400 mb-4 text-center">O RETORNO INEVITÁVEL</h3>
              <div className="text-center space-y-3">
                <p className="text-gray-300 text-base lg:text-lg">
        ...
        <div className="page-break min-h-screen bg-gradient-to-br from-gray-900 to-black p-8 print:p-4 relative">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            <div className="bg-gradient-to-r from-green-600/30 to-green-400/30 border border-green-500/50 rounded-xl p-6">
              <h3 className="text-xl lg:text-2xl font-bold text-green-400 mb-4 text-center">A FILOSOFIA DE TAYNÃ</h3>
        ...
        <div className="page-break min-h-screen bg-gradient-to-br from-black to-gray-900 p-8 print:p-4 relative">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            <div className="bg-black/40 backdrop-blur-md border border-green-500/30 rounded-xl p-6 mb-8">
              <h3 className="text-2xl lg:text-3xl font-bold text-green-400 mb-4 text-center">NOSSA MISSÃO</h3>
            ...
            <div className="bg-gradient-to-r from-green-600/30 to-green-400/30 border border-green-500/50 rounded-xl p-6">
              <h3 className="text-xl lg:text-2xl font-bold text-green-400 mb-4 text-center">OS ORÁCULOS DO FUTURO ANCESTRAL</h3>
        ...
        <div className="page-break min-h-screen bg-gradient-to-br from-gray-900 to-black p-8 print:p-4 relative">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="bg-black/40 backdrop-blur-md border border-green-500/30 rounded-xl p-6">
                <h3 className="text-2xl lg:text-3xl font-bold text-green-400 mb-4 text-center">
            ...
            <div className="bg-gradient-to-r from-green-600/30 to-green-400/30 border border-green-500/50 rounded-xl p-6">
              <h3 className="text-xl lg:text-2xl font-bold text-green-400 mb-4 text-center">A PROMESSA HONESTA</h3>
              <div className="text-center space-y-3">
        ...
        <div className="page-break min-h-screen bg-gradient-to-br from-gray-900 to-black p-8 print:p-4 relative">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="space-y-6">
                <div className="bg-black/40 backdrop-blur-md border border-green-500/30 rounded-xl p-6 text-center">
            ...
            <div className="bg-gradient-to-r from-green-600/30 to-green-400/30 border border-green-500/50 rounded-xl p-6">
              <h3 className="text-2xl lg:text-3xl font-bold text-green-400 mb-4 text-center">O NOVO POSICIONAMENTO</h3>
              <div className="text-center space-y-4">
