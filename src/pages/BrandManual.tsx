...
const BrandManual = () => {
  useEffect(() => {
    // Importar e inicializar Paged.js
    const loadPagedjs = async () => {
      try {
        const { Previewer } = await import('pagedjs');
        const previewer = new Previewer();
        
        // Inicializar apenas quando for para impressão/PDF
        ...
        console.log('Paged.js não carregado, usando CSS de impressão padrão');
      }
    };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <div className="pt-20 print:pt-0">
        {/* Page 1: Cover */}
        <section className="page-break min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <section className="page-break min-h-screen bg-gradient-to-br from-gray-900 to-black relative">
          {/* Background Image */}
        ...
        <section className="page-break min-h-screen bg-gradient-to-br from-black to-gray-900 relative">
          {/* Background Image */}
        ...
        <section className="page-break min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 relative">
          {/* Background Image */}
          <div className="absolute inset-0 opacity-10">
            <img 
      ...
      <style>{`
        ...
        /* Paged.js interface customization */
        .pagedjs_pages {
          display: flex;
